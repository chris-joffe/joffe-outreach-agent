...
def generate_batch(contacts):
    ...
    system = (
        ...
        "you well'. No 'this isn't a pitch'. No exclamation points. No hard close. Never "
        "mention price or discounts. Prevention-first and confidence-building, never fear- or "
        "liability-based.\n\n"
